page 52178724 "FIN-Payment Header"
{
    Caption = 'Payment Voucher Card';
    DeleteAllowed = false;
    PageType = Card;
    PromotedActionCategories = 'New,Action,Navigation,Process,Request Approval,Approval,Post,Reports,Print/Send,Check';
    ...
    begin
        ...
        IF PayLine.FIND('-') THEN BEGIN
            ...
            REPEAT
                ...
                GenJnlLine.VALIDATE(GenJnlLine."Account No.");
                GenJnlLine."External Document No." := Payments."Cheque No.";
                GenJnlLine.Description := Payments."Payment Narration";
        ...
        IF FINPaymentLine.FIND('-') THEN BEGIN
            ...
            BEGIN
               ...
               FINBudgetEntries."Commitment Status"::Commitment);
                ...
                FINBudgetEntries.setrange(Date, PostBudgetEnties.GetBudgetStartDate(Rec.Date), PostBudgetEnties.GetBudgetEndDate(Rec.Date));
