report 52178891 "RFQ Report2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/RFQReport2.rdl';
    ...
    dataset
    {
        dataitem("PROC-Quotation Request Vendors"; "PROC-Quotation Request Vendors")
        {
            ...
            dataitem("PROC-Purchase Quote Header"; "PROC-Purchase Quote Header")
            {
                ...
                column(Expected_Opening_Date; Format("Expected Opening Date"))
                {

                }
                column(Closing_Time; "Closing Time")
                {
