table 52178713 "FIN-Payment Line"
{
    ...
    fields
    {
        ...
        field(13; "Account No."; Code[20])
        {
            ...
            ELSE
            if ("Account Type" = CONST(Employee)) "HRM-Employee (D)"
            ...
            begin
                ...
                IF "Account Type" IN ["Account Type"::"G/L Account", "Account Type"::Customer, "Account Type"::Vendor, "Account Type"::"IC Partner", "Account Type"::Employee,
                ...
                THEN
                    CASE "Account Type" OF
                        ...
                        "Account Type"::Employee:
                            begin
                                HrmEmp.Get("Account No.");
                                "Account Name" := HrmEmp."First Name" + ' '+HrmEmp."Middle Name"+ ' ' + HrmEmp."Last Name";
                            end;
                    END;
        ...
        field(50024; "Customer Posting"; code[20])
        {
            TableRelation = "Customer Posting Group".Code;
        }
