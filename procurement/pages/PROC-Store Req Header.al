page 52178765 "PROC-Store Req. Header (B)"
{
                    ...
                    begin
                        ...
                        IF ReqLine.FIND('-') THEN BEGIN
                            ...
                            BEGIN
                                ...
                                InventoryItem.Reset();
                                InventoryItem.SetRange("No.", ReqLine."No.");
                                IF InventoryItem.Find('-') then begin
                                    GenJnline."Gen. Prod. Posting Group" := InventoryItem."Gen. Prod. Posting Group"
                                end;
...
;
            ...
            group(Reports)
            {
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        REPORT.Run(52178710, true, true, Rec);
                        Rec.Reset;
                    end;
                }
            }
    ...
    procedure ReleaseAndOpenDocument()
    var
        UserSetUp: Record "User Setup";
        Notifi: Codeunit "Notification Management";
    begin
        Message('The Document Should go through approval workflow');
    end;
